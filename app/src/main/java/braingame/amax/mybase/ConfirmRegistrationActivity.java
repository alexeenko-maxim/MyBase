...
public class ConfirmRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_registration_);
...
//        mOtpText = findViewById(R.id.otp_text_view);
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
            .addOnCompleteListener(ConfirmRegistrationActivity.this, new OnCompleteListener<AuthResult>() {
                @Override
    ...
    public void sendUserToHome() {
        Intent homeIntent = new Intent(ConfirmRegistrationActivity.this, MainActivity.class);
